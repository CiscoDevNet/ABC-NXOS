...
if __name__ == "__main__":
    ...
    parser.add_argument('--vault_backend_type', default='kv-v1', help=' the Vault backend type for the secrets engine')
    ...
    """
    created_policy = client.sys.create_or_update_policy("nxos-access", admin_policy)
    logger.debug("created/updated policy response=%s", created_policy)

    created_role = client.create_role("bootcamp", policies="nxos-access")
